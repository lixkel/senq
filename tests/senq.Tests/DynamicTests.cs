...
namespace senq.Tests {
    ...
    /// <summary>
    /// This tests are testing if the dynamic part of the senq scraper is working correctly
    /// </summary>
    ...
    public class DynamicTests {
        ...
        */
        public void DynamicScraping_String_WithMatches(string expected, int maxDepth, string targetRegex) {
            // Arrange
            string result = "";
        ...
        /// </summary>
        [Fact]
        public void Dynamiccraping_String_NoMatches() {
            // Arrange
            string expected = "";
        ...
        /// and ensures that the scraper can identify dynamically loaded content from JavaScript
        /// </summary>
        [Fact]
